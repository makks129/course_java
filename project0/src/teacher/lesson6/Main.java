...
//
//        Circle c1 = new Circle(10, 0, 0, GeometricObject.COLOR_RED);
//
//        System.out.println(Circle.getNumberOfCircles()); // 1
//
//        Circle c2 = new Circle(10, 0, 0, GeometricObject.COLOR_RED);
//
//        System.out.println(Circle.getNumberOfCircles()); // 2
//
//        Circle c3 = new Circle(10, 0, 0, GeometricObject.COLOR_RED);
//
